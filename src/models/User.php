...
class User extends Model
{
    ...
    public function insert()
    {
        ...
        $this->end_date = $this->end_date ? $this->end_date : null;
    ...
    public function validate()
    {
        ...
        if (!$this->start_date) {
            ...
            $errors["start_date"] = "Data de admissão deve seguir o formato dd/mm/aaaa.";
        }

        if ($this->end_date && !DateTime::createFromFormat('Y-m-d', $this->end_date)) {
            $errors["end_date"] = "Data de desligamento deve seguir o formato dd/mm/aaaa.";
        }
        ...
        if (!$this->confirm_password) {
            $errors["confirm_password"] = "Por favor, informe a confirmação de senha.";
        }
